...
Fettgedruckter Text kann folgendermaßen geschierben werden: 
...
Wenn wir etwas als Code (z.B. R-Code) ausweisen wollen, könne wir den Text durch Grave-Akzente ( ` ) umschließen, wie hier:
...
> **knitten** Sie anschlißend das Dokument neu.
...
Sie können neue Codeblöcke auch mit dieser kleinen Button in R-Studio.
