...
```{r}
gedaetnis <- data.frame(subject_id = 1:10,
...
Nun schauen wir uns zwei weitere Funktion an: `pivot_longer` und `pivot_wider` aus dem R-Paket `tidyr`.
...
```{r}
# url <- "https://raw.githubusercontent.com/allisonhorst/stats-illustrations/main/rstats-artwork/tidydata_2.jpg"
...
Was passiert, wenn Sie `names_to = "Spaltenbenennung"` anstatt
des ursprünglichen Codes benutzen?
